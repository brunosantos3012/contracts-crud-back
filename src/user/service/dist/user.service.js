...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getByCode = function (code) {
        return this.repository.findOne(code, { relations: ['situation'] });
    };
    ...
    UserService.prototype.update = function (code, userData) {
        return this.repository.update(code, userData);
    };
    UserService.prototype["delete"] = function (code) {
        return this.repository.update(code, { situation: '2' });
    };
